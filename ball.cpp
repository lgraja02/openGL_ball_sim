#include "ball.hpp"
#include "terrain.hpp" // <- bardzo ważne! (żeby mieć heightFunction!)
#include <glad/glad.h>
#include <glm/glm.hpp>
...
void Ball::draw() {
    ...
    GLuint baseColorLoc = glGetUniformLocation(ballShaderProgram, "baseColor");
    glUniform3fv(baseColorLoc, 1, glm::value_ptr(glm::vec3(1.0f, 0.0f, 0.0f))); //zmiana koloru kulki
    ...
    glUniform3fv(viewPosLoc, 1, glm::value_ptr(Position)); // Możesz też użyć pozycji kamery
